'''Math Game
Filename: mathgameexample 1.4.0
Date 14/05/2025
Version: 1.4.0
- 
...
button_img = PhotoImage(file="start.png")  # Replace with your image path
button_img = button_img.subsample(100) 
# Start Button
start = Button(app, image = button_img, font= ("Times New Roman","10"), command=try_again)
start.place(relx=0.30, rely=0.1, relheight= 0.1, relwidth = 0.4)
start.image = button_img  
