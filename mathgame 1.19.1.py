...
def show_leaderboard():
    ...
    tk.Label(selector, text="Select Leaderboard for Difficulty", font=("Helvetica", 14, "bold")).pack(pady=15)

    # Adds buttons for each difficulty
    for diff in ["Easy", "Medium", "Hard"]:
        tk.Button(selector, text=diff, font=("Helvetica", 12), width=15,
