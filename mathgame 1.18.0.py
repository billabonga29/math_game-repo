...
def show_leaderboard():
    ...
    leaderboard_str = ""
    for i, (name, time_taken) in enumerate(leaderboard_entries, start=1):
        leaderboard_str += f"{i}. {name}: {time_taken:.2f} seconds\n"
    ...
    text_box = tk.Text(leaderboard_window, font=("Helvetica", 12), wrap="none", bg="white", width=40, height=20)
    text_box.insert(tk.END, leaderboard_str)
