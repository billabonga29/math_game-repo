...
def show_leaderboard():
    ...
    # Read and parse the leaderboard entries
    leaderboard_entries = []
    ...
    leaderboard_window.geometry("370x400")

    # This is the header label for the leaderboard window.
    tk.Label(leaderboard_window, text="🏁 Leaderboard 🏁", font=("Helvetica", 16, "bold")).pack(pady=10)

    # Use treeview widget for leaderboard table
    columns = ("Name", "Time")
    tree = ttk.Treeview(leaderboard_window, columns=columns, show="headings", height=15)

    # Add style to the heading(bold)
    style = ttk.Style()
    ...
    # This centre aligns the text in the columns
